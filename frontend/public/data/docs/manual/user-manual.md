# User Manual - TaskMan Documentation

Automatically generated documentation from PRD
...
- [1.1 Strategic Positioning](#11-strategic-positioning)
...
- [2. Feature Specifications](#2-feature-specifications)
  - [2.1 Authentication & Session Management](#21-authentication-session-management)
    - [2.1.1 Registration](#211-registration)
    - [2.1.2 Login](#212-login)
    - [2.1.3 Logout](#213-logout)
    - [2.1.4 Session Refresh](#214-session-refresh)
    - [2.1.5 Current User](#215-current-user)
    - [2.1.6 Frontend Auth State](#216-frontend-auth-state)
  - [2.2 User Profile Management](#22-user-profile-management)
    - [2.2.1 Update Profile](#221-update-profile)
    - [2.2.2 Change Password](#222-change-password)
    - [2.2.3 Frontend Profile Page](#223-frontend-profile-page)
  - [2.3 Project Management](#23-project-management)
    - [2.3.1 List Projects](#231-list-projects)
    - [2.3.2 Get Project Detail](#232-get-project-detail)
    - [2.3.3 Create Project](#233-create-project)
    - [2.3.4 Update Project](#234-update-project)
  ...
  - [2.5 Task Management](#25-task-management)
    - [2.5.1 List Tasks](#251-list-tasks)
    - [2.5.2 Get Task](#252-get-task)
    - [2.5.3 Create Task](#253-create-task)
    - [2.5.4 Update Task](#254-update-task)
    - [2.5.5 Delete Task](#255-delete-task)
    - [2.5.6 Bulk Status Update](#256-bulk-status-update)
    - [2.5.7 Frontend: Table View](#257-frontend-table-view)
    - [2.5.8 Frontend: Kanban Board View](#258-frontend-kanban-board-view)
    - [2.5.9 Frontend: View Toggle](#259-frontend-view-toggle)
    - [2.5.10 Task Modal](#2510-task-modal)
    - [2.5.11 Recurring Tasks](#2511-recurring-tasks)
      - [Overview](#overview)
      - [Endpoints](#endpoints)
      - [Database Schema](#database-schema)
      - [Recurrence Calculation Rules](#recurrence-calculation-rules)
      - [Scheduled Job](#scheduled-job)
      - [Frontend Features](#frontend-features)
      - [Authorization](#authorization)
    - [2.5.12 Task Dependencies](#2512-task-dependencies)
      - [Overview](#overview)
      - [Endpoints](#endpoints)
      - [Database Schema](#database-schema)
      - [Circular Dependency Prevention](#circular-dependency-prevention)
      - [Frontend Features](#frontend-features)
      - [Auto-adjust Due Dates](#auto-adjust-due-dates)
      - [Authorization](#authorization)
      - [Critical Path Calculation](#critical-path-calculation)
  - [2.6 Dashboard](#26-dashboard)
    - [2.6.1 Statistics Cards](#261-statistics-cards)
    - [2.6.2 Recent Tasks](#262-recent-tasks)
    - [2.6.3 Recent Projects](#263-recent-projects)
  - [2.7 Navigation & Layout](#27-navigation-layout)
    - [2.7.1 Layout Structure](#271-layout-structure)
    - [2.7.2 Protected Routes](#272-protected-routes)
  - [2.8 Health Check](#28-health-check)
  - [2.9 Notifications System](#29-notifications-system)
    - [2.9.1 List Notifications](#291-list-notifications)
    - [2.9.2 Notification Types](#292-notification-types)
    - [2.9.3 Mark as Read](#293-mark-as-read)
    - [2.9.4 Delete Notification](#294-delete-notification)
    - [2.9.5 Frontend Integration](#295-frontend-integration)
  - [2.10 Analytics & Insights](#210-analytics-insights)
    - [2.10.1 Productivity Insights](#2101-productivity-insights)
    - [2.10.2 Insight Generation](#2102-insight-generation)
    - [2.10.3 Creator Accountability Dashboard](#2103-creator-accountability-dashboard)
    - [2.10.4 Future Analytics](#2104-future-analytics)
  - [2.11 User Preferences](#211-user-preferences)
    - [2.11.1 Color Themes](#2111-color-themes)
    - [2.11.2 Layout Preferences](#2112-layout-preferences)
    - [2.11.3 Density Settings](#2113-density-settings)
  - [2.12 Quick Actions](#212-quick-actions)
    - [2.12.1 Command Palette](#2121-command-palette)
      - [Overview](#overview)
      - [Keyboard Shortcut](#keyboard-shortcut)
      - [Features](#features)
      - [Visual Design](#visual-design)
      - [Implementation](#implementation)
    - [2.12.2 Command Groups](#2122-command-groups)
  - [2.13 Time Tracking](#213-time-tracking)
    - [2.13.1 Manual Entry](#2131-manual-entry)
    - [2.13.2 Start/Stop Timer](#2132-startstop-timer)
    - [2.13.2 Timer Workflow](#2132-timer-workflow)
    - [2.13.3 Manual Time Entry](#2133-manual-time-entry)
    - [2.13.4 Time Aggregation](#2134-time-aggregation)
    - [2.13.5 Pomodoro Mode](#2135-pomodoro-mode)
    - [2.13.6 Calendar View](#2136-calendar-view)
  - [2.14 Activity Logs](#214-activity-logs)
    - [2.14.1 Endpoints](#2141-endpoints)
    - [2.14.2 Tracked Events](#2142-tracked-events)
    - [2.14.3 Middleware Implementation](#2143-middleware-implementation)
    - [2.14.4 Frontend Display](#2144-frontend-display)
  - [2.15 Comments & Real-time Collaboration](#215-comments-real-time-collaboration)
    - [2.5.11 Recurring Tasks](#2511-recurring-tasks)
    - [2.5.12 Task Dependencies](#2512-task-dependencies)
    - [2.15.1 Comments System](#2151-comments-system)
    - [2.15.2 Comment Database Schema](#2152-comment-database-schema)
    - [2.15.3 @Mentions](#2153-mentions)
    - [2.15.4 WebSocket Real-time Updates](#2154-websocket-real-time-updates)
    - [2.15.5 Real-time Event Flow](#2155-real-time-event-flow)
    - [2.15.6 Presence Indicators](#2156-presence-indicators)
    - [2.15.7 WebSocket Scalability](#2157-websocket-scalability)
  - [2.16 Custom Fields & Attachments](#216-custom-fields-attachments)
    - [2.16.1 Custom Fields](#2161-custom-fields)
    - [2.16.2 Custom Field Database Schema](#2162-custom-field-database-schema)
    - [2.16.3 Tags System](#2163-tags-system)
    - [2.16.4 File Attachments](#2164-file-attachments)
    - [2.16.5 File Attachment Database Schema](#2165-file-attachment-database-schema)
    - [2.16.6 Frontend Features](#2166-frontend-features)
  - [2.17 CLI Tool](#217-cli-tool)
    - [2.17.1 Installation](#2171-installation)
    - [2.17.2 Authentication](#2172-authentication)
    - [2.17.3 Commands Implemented](#2173-commands-implemented)
    - [2.17.4 Create Options](#2174-create-options)
    - [2.17.5 List Filters](#2175-list-filters)
    - [2.17.6 Output Formatting](#2176-output-formatting)
    - [2.17.7 Shell Completion](#2177-shell-completion)
  - [2.18 Public API](#218-public-api)
    - [2.18.1 API Key Authentication](#2181-api-key-authentication)
    - [2.18.2 API Key Database Schema](#2182-api-key-database-schema)
    - [2.18.3 Rate Limiting](#2183-rate-limiting)
    - [2.18.4 API Documentation](#2184-api-documentation)
    - [2.18.5 Available Endpoints](#2185-available-endpoints)
  - [2.19 Webhooks](#219-webhooks)
    - [2.19.1 Webhook Configuration](#2191-webhook-configuration)
    - [2.19.2 Webhook Events](#2192-webhook-events)
    - [2.19.3 Webhook Payload](#2193-webhook-payload)
    - [2.19.4 HMAC Signature](#2194-hmac-signature)
    - [2.19.5 Retry Logic](#2195-retry-logic)
    - [2.19.6 Webhook Logs](#2196-webhook-logs)
  - [2.20 Natural Language Task Creation](#220-natural-language-task-creation)
    - [2.20.1 Smart Quick-Add Bar](#2201-smart-quick-add-bar)
    - [2.20.2 Parsing Examples](#2202-parsing-examples)
    - [2.20.3 Pattern Detection](#2203-pattern-detection)
    - [2.20.4 Date Parsing Library](#2204-date-parsing-library)
    - [2.20.5 NLP Library](#2205-nlp-library)
    - [2.20.6 Fallback Behavior](#2206-fallback-behavior)
    - [2.20.7 Frontend Preview](#2207-frontend-preview)
  - [2.21 Focus Mode](#221-focus-mode)
    - [2.21.2 Frontend Implementation](#2212-frontend-implementation)
    - [2.21.3 Behavior](#2213-behavior)
    - [2.21.4 Visual Design](#2214-visual-design)
    - [2.21.5 Use Cases](#2215-use-cases)
  - [2.22 UI/UX Design System](#222-uiux-design-system)
    - [2.22.1 Glassmorphism](#2221-glassmorphism)
    - [2.22.2 Micro-interactions](#2222-micro-interactions)
    - [2.22.3 Framer Motion Integration](#2223-framer-motion-integration)
    - [2.22.4 Skeleton Loading States](#2224-skeleton-loading-states)
  ...
  - [2.25 Pagination System](#225-pagination-system)
    ...
    - [2.25.4 Frontend Component](#2254-frontend-component)
    - [2.25.5 Auto-Reset Behavior](#2255-auto-reset-behavior)
    - [2.25.6 Limit Clamping](#2256-limit-clamping)
    - [2.25.7 Performance Considerations](#2257-performance-considerations)
- [3. Data Model](#3-data-model)
  - [3.1 Merged Prisma Schema](#31-merged-prisma-schema)
  - [3.2 Key Schema Decisions](#32-key-schema-decisions)
- [4. API Summary](#4-api-summary)
  - [4.1 Core API Endpoints](#41-core-api-endpoints)
  - [4.2 WebSocket Events](#42-websocket-events)
- [5. Tech Stack](#5-tech-stack)
  - [5.1 Frontend](#51-frontend)
  - [5.2 Backend](#52-backend)
  - [5.3 Infrastructure](#53-infrastructure)
  - [5.4 Stack Decisions Not Carried Forward](#54-stack-decisions-not-carried-forward)
...
<!-- Metadata: {"audience":["admin","developer"]} -->
...
#### 2.5.8 Frontend: Kanban Board View
...
<!-- Metadata: {"audience":["developer"],"surface":["docs"]} -->
